...
public class ComparacionPrecios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Producto", "Precio", "Fecha Reporte", "Ver Producto", "Liberar"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        txtRegresar.setBackground(new java.awt.Color(0, 2, 2));
        txtRegresar.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
